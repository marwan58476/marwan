...
module.exports = {
  ...
  if (!message.member.voice.channel) return
   if (message.member.voice.channel.id != "1000881139336089751") return
   ...
   if(ress && ress.Prefix)prefix = ress.Prefix;
    ...
    if (command.args && !args.length) {
        let reply = `**Welcome to Memories Music system :notes: ** \n **please provide any arguments**, ${message.author}!`;
